...
replace go.opentelemetry.io/otel v1.35.0 => go.opentelemetry.io/otel v1.46.0
...
replace golang.org/x/net v0.46.0 => golang.org/x/net v0.58.0

replace google.golang.org/grpc v1.72.1 => google.golang.org/grpc v1.83.2
